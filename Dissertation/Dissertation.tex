...
\end{tikzpicture}
\caption{Simple fully connected feedforward neural network with one hidden layer.}
...
\begin{equation}
P(\bs{x}_i \mid \bs{t},\bs{p}) = \frac{P(\bs{x}_i\mid\bs{t},\bs{p}_i)P(\bs{t}\mid\bs{p})P(\bs{p})P(\bs{x}_i)}{P(\bs{p}_i\mid\bs{t},\bs{x}_i)P(\bs{t}\mid\bs{x}_i)}\qquad
...
%TODO This sounds a bit shit, put more work here
