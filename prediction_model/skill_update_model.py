...
from prediction_model.utils import log_normal, make_mu_and_sigma, make_bigger_sql_nn, make_sql_nn
...
nn = make_bigger_sql_nn(PLAYER_DIM + GAMES_TO_CONSIDER * PLAYER_DIM * 2, PLAYER_DIM * 2)
